...
static void initDistance(double &distance) {
    distance = SignedDistance::INFINITE_SIGNED_DISTANCE.distance;
}

static void initDistance(MultiDistance &distance) {
    distance.r = SignedDistance::INFINITE_SIGNED_DISTANCE.distance;
    distance.g = SignedDistance::INFINITE_SIGNED_DISTANCE.distance;
    distance.b = SignedDistance::INFINITE_SIGNED_DISTANCE.distance;
}
