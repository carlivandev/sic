...
void main()
{
    ...
    vec4 smoothing_r_unused_gba = read_vec4(instance_data_texture_sampler, instance_data_begin, instance_data_it);
    smoothing_r_unused_gba.r = 0.25f / (8.0f * offset_and_size.z);
